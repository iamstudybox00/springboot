...
public class MainController
{
    ...
    private final B07cMybatisLogbackApplication b07bMybatisParameterApplication;	
	@Autowired
	IMemberService dao;

    MainController(B07cMybatisLogbackApplication b07bMybatisParameterApplication) {
