...
public class MainController
{
    ...
    private final B07bMybatisParameterApplication b07bMybatisParameterApplication;	
	@Autowired
	IMemberService dao;

    MainController(B07bMybatisParameterApplication b07bMybatisParameterApplication) {
        this.b07bMybatisParameterApplication = b07bMybatisParameterApplication;
    }
