...
public class MainController
{
    ...
    private final B08aTransactionManagerApplication b08aTransactionManagerApplication;	
	@Autowired
	ITicketService dao;
    ...
    MainController(B08aTransactionManagerApplication b08aTransactionManagerApplication) {
        this.b08aTransactionManagerApplication = b08aTransactionManagerApplication;
    }
